    ...
    >
      ...
      >
        ...
        <InputSection
          ...
          desiredSubnets={desiredSubnets}
          desiredHosts={desiredHosts}
          ipValidation={ipValidation}
          subnetsValidation={subnetsValidation}
          hostsValidation={hostsValidation}
          isCalculating={isCalculating}
          error={error}
          onModeChange={handleModeChange}
          onIPInputChange={handleIPInputChange}
          onSubnetIndexChange={setSubnetIndex}
          onSubnetsInputChange={handleSubnetsInputChange}
          onHostsInputChange={handleHostsInputChange}
        ...
        {result && (
          <>
            ...
            {result.subnetRanges && result.subnetRanges.length > 0 && (
              <QuickSubnetLookup
                subnetRanges={result.subnetRanges}
                isDark={isDark}
                theme={theme}
              />
            )}
                  ...
                  <div className="flex flex-wrap gap-2 justify-center">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        disabled={
                          !pageInputValue || parseInt(pageInputValue) < 1
                        }
        ...
        {/* Footer / Credits */}
        <div
          className={`mt-8 pt-6 pb-24 lg:pb-6 border-t ${
            isDark ? "border-slate-700" : "border-gray-200"
          } text-center`}
        >
          <p
          ...
          >
            © 2025 Tinga Chiingeni. All Rights Reserved.
          </p>
        </div>
      </div>
